...
[![GitHub Tests Action Status](https://img.shields.io/github/actions/workflow/status/worksome/translator/tests.yml?branch=main&label=Tests&style=flat-square)](https://github.com/worksome/translator/actions?query=workflow%3ATests)
[![GitHub PHPStan Action Status](https://img.shields.io/github/actions/workflow/status/worksome/translator/static.yml?branch=main&label=PHPStan&style=flat-square)](https://github.com/worksome/translator/actions?query=workflow%3APHPStan)
